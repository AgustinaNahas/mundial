...
export function FernetSection() {
  ...
  return (
    ...
    >
        ...
        <div className="space-y-8">
          ...
          >
            ...
            <div className="flex items-baseline gap-4 mt-2">
              <div>
                <p className="text-2xl font-light text-primary">{formatCurrency(fernet_2022, fernet?.unidad)}</p>
                <p className="text-xs text-muted-foreground">2022</p>
              </div>
              <span className="text-muted-foreground">→</span>
              <div>
                <p className="text-2xl font-light text-accent">{formatCurrency(fernet_2026, fernet?.unidad)}</p>
      ...
      <SourcesPanel items={[fernet, salario]} />
    </SectionWrapper>
  )
}
