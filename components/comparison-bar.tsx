...
export function ComparisonBar({
  ...
  const tooltipLines = (
    ...
    referenceSwatchStyle: CSSProperties,
  ) => (
    <div className="space-y-2 text-left">
      ...
      {referenceLabel != null && referenceValue != null && (
        <div className="flex items-start gap-2.5">
          <span
            className="mt-1 size-2.5 shrink-0 rounded-sm border-2 border-dashed bg-transparent"
            style={referenceSwatchStyle}
            aria-hidden
          />
          <p className="min-w-0 leading-snug">
  ...
  const ref2022Border: CSSProperties = { borderColor: "rgba(0, 164, 220, 0.9)" }
  const ref2026Border: CSSProperties = { borderColor: "rgba(255, 255, 255, 0.9)" }
  ...
  const bindFollowTooltip = (
    ...
    onPointerEnter: (e) => set({ open: true, x: e.clientX, y: e.clientY }),
    onPointerMove: (e) => set({ open: true, x: e.clientX, y: e.clientY }),
    onPointerLeave: () => set({ open: false, x: 0, y: 0 }),
  })
      ...
      <div className="space-y-3">
        ...
        <div className="flex min-w-0 items-center gap-2 sm:gap-4">
          ...
          >
            <div className="relative flex h-8 min-w-0 flex-row items-stretch overflow-hidden rounded bg-muted">
              ...
              {compact2022 && (
                <div className="hidden truncate pl-2 pr-1 text-xs font-medium text-accent md:block">
                  {displayValue(value2022)}
                </div>
              )}
              ...
              {referenceValue2022 != null && (
                <motion.div
                  ...
                  className="pointer-events-none absolute top-0 left-0 z-10 h-full rounded"
                  style={{
                    border: "2px dashed rgba(0, 164, 220, 0.9)",
          ...
          <FollowCursorTooltip
            ...
            y={tip2022.y}
          >
            {tooltipLines("2022", value2022, referenceValue2022, "bg-accent", ref2022Border)}
          </FollowCursorTooltip>
        </div>
        ...
        <div className="flex min-w-0 items-center gap-2 sm:gap-4">
          ...
          <FollowCursorTooltip
            ...
            y={tip2026.y}
          >
            {tooltipLines("2026", value2026, referenceValue2026, "bg-primary", ref2026Border)}
          </FollowCursorTooltip>
        </div>

        {referenceLabel && (referenceValue2022 != null || referenceValue2026 != null) && (
          <div className="flex items-center pl-14 text-xs text-muted-foreground/70 sm:pl-16">
            <div
              className="h-4 w-6 shrink-0 rounded-l"
              style={{
                borderTop: "2px dashed rgba(0, 164, 220, 0.75)",
                borderBottom: "2px dashed rgba(0, 164, 220, 0.75)",
                borderLeft: "2px dashed rgba(0, 164, 220, 0.75)",
              }}
            />
            <div
              className="mr-4 h-4 w-6 shrink-0 rounded-r"
              style={{
                borderTop: "2px dashed rgba(255,255,255,0.75)",
